void Pr3_waveforms_baseline_cathode() {
  ...
  for (int j=1; j<2; j++) {
    ...
    //double x_roll3[350], y_roll3[350];                                                                                                              
    ...
    TMultiGraph* gr = new TMultiGraph("Baseline for different averaging", "Baseline for different cathode averaging;Time (s);Voltage(V)");
    gr->Add(ano_raw1);
    gr->Add(ano_roll3);
    gr->Add(ano_roll);
    gr->Add(ano_roll2);
    ...
    gr->Draw("AL");
    canvas->BuildLegend();
    canvas->Print(Form("silver_vacuum_10.3_waveform%d_cathodebaseline_baseline.png", j));
    //canvas->Close();                                                                                                                                
